...
var PIDs = {
    service01 : {
        ...
        "06": { realtime: true, name: "Short term fuel trim - Bank 1", min: -100, max: 100, length: 1, unit: "%", convert: convertFuelTrim},
        "07": { realtime: true, name: "Long term fuel trim - Bank 1", min: -100, max: 100, length: 1, unit: "%", convert: convertFuelTrim},
        "08": { realtime: true, name: "Short term fuel trim - Bank 2", min: -100, max: 100, length: 1, unit: "%", convert: convertFuelTrim},
        "09": { realtime: true, name: "Long term fuel trim - Bank 2", min: -100, max: 100, length: 1, unit: "%", convert: convertFuelTrim},
        "0A": { realtime: true, name: "Fuel pressure", min: 0, max: 765, length: 1, unit: "kPa", convert: convertFuelPressure},
        "0B": { realtime: true, name: "Intake manifold absolute pressure", min: 0, max: 255, length: 1, unit: "%", convert: convertIntakeAbsolutePressure},
        "0C": { realtime: true, name: "Engine RPM", min: 0, max: 16400, length: 2, unit: "RPM", convert: convertRPM},
